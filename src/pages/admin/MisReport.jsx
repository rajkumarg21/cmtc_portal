...
import { getMISCounts } from "../../services/bookingService";
  ...
  return (
    <>
      ...
      <h4 className="text-center fw-bold mb-4">
       {t("sidebar.Revenue_Page_heading")}
      </h4>
      ...
      <div className="row g-3 mb-4">
        ...
        <div className="col-md-2 col-sm-6">
          <div className="stat-card stat-blue">
            <div>
              <small className="text-white">{t("admin.advanceAmount")}</small>
              <h2 className="fw-bold text-white">
                {loading ? "..." : `₹${data.advancedAmountSum}`}
              </h2>
            </div>
        ...
        <div className="col-md-2 col-sm-6">
          <div className="stat-card stat-orange">
            <div>
              ...
              <h2 className="fw-bold text-white">
                {loading ? "..." : `₹${data.remainingAmountSum}`}
              </h2>
            </div>
        ...
        <div className="col-md-2 col-sm-6">
          <div className="stat-card stat-green">
            <div>
              <small className="text-white">{t("admin.advancePaid")}</small>
              <h2 className="fw-bold text-white">
                {loading ? "..." : `₹${data.advancedPaidAmount}`}
              </h2>
            </div>
        ...
        <div className="col-md-2 col-sm-6">
          <div className="stat-card stat-green">
            <div>
              <small className="text-white">{t("admin.fullyPaid")}</small>
              <h3 className="fw-bold text-white">
                {loading ? "..." : `₹${data.totalFullyPaidAmount}`}
              </h3>
            </div>
        ...
        <div className="col-md-2 col-sm-6">
          <div className="stat-card stat-blue">
            <div>
              ...
              <h3 className="fw-bold text-white">
                {loading ? "..." : `₹${data.totalReceivedAmount}`}
              </h3>
            </div>
