     ...
     <Typography
      ...
      <Box display="flex" justifyContent="center" mb={3}>
        <ToggleButtonGroup
          ...
          aria-label="mode"
        >
          <ToggleButton value="main" aria-label="main mode">Main Department</ToggleButton>
          <ToggleButton value="sub" aria-label="sub mode">Sub Department</ToggleButton>
        </ToggleButtonGroup>
      </Box>
      ...
      <Paper elevation={3} sx={{ p: 4, mb: 4 }}>
        <Typography variant="h5" align="center" gutterBottom>
          {mode === 'main' ? (isEditingMain ? 'Edit Main Department' : 'Add Main Department') : (isEditingSub ? 'Edit Sub Department' : 'Add Sub Department')}
        </Typography>
        ...
        <Box component="form" onSubmit={mode === 'main' ? handleSubmitMain : handleSubmitSub} noValidate>
          <Grid container spacing={2} alignItems="center">
            {mode === 'sub' && (
              <Grid item xs={12} sm={4}>
                <FormControl fullWidth required error={!!validationErrors.mainId}>
                  <InputLabel id="main-select-label">Main Department</InputLabel>
                  <Select
            ...
            <Grid item xs={12} sm={mode === 'sub' ? 6 : 8}>
              <TextField
                fullWidth
                label="Name"
                name="name"
      ...
      <Paper elevation={3} sx={{ p: 4 }}>
        <Typography variant="h5" align="center" gutterBottom>
          {mode === 'main' ? 'All Main Departments' : (selectedMainId ? `Sub Departments of "${mainDepartments.find(m => m.id === selectedMainId)?.name || ''}"` : 'All Sub Departments')}
        </Typography>
