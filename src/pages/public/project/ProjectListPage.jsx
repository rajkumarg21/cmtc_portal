...
const ProjectListPage = () => {
  ...
  const getLocalizedTitle = (project) =>
    isHindi
      ? project.titleHindi || project.titleEnglish
      : project.titleEnglish || project.titleHindi;

  const getLocalizedSummary = (project) =>
    isHindi
      ? project.summaryHindi || project.summaryEnglish
      : project.summaryEnglish || project.summaryHindi;
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        ...
        console.error("Error fetching Act and Rules:", err);
        setError("Failed to fetch Act and Rules. Showing sample data.");
        setProjects(defaultProjects);
      } finally {
        setLoading(false);
      }
              ...
              >
                ...
                >
                  <CardMedia
                    ...
                    image={
                      project.imageUrl
                        ? `${import.meta.env.VITE_BASE_URL}${project.imageUrl}`
                    ...
                    <Box sx={{ mt: "auto", pt: 2 }}>
                      <Button
                        ...
                        sx={{
                          ...
                          "&:hover": {
                            background:
                              "linear-gradient(90deg, #1976d2, #0d8ddb)",
                          },
                        }}
                      >
